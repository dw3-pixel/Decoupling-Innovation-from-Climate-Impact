...
sdg_analysis <- sdg_data %>% 
  ...
  # Forcing R to use the dplyr::rename function to prevent multiple error messages
...
Visual Inspection (Histograms) - to justify the choice of a non-parametric test (Spearman's ρ).
...
ggcorrplot(
    ...
    title = "Spearman Correlation Heatmap of SDGs"
)
```
